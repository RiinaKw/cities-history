				...
				<div class="modal-dialog modal-lg" role="document">
					<form class="modal-content" action="#" method="post">
						...
						<div class="modal-body">
							...
							<span class="row_add">
								<button type="button" class="btn btn-light"><i class="fas fa-plus"></i> 追加</button>
							</span>
						</div><!-- /.modal-body -->
...
{
	var $tr1 = $("<tr />").addClass("ui-state-default").appendTo($tbody);
	var $tr2 = $("<tr />").addClass("ui-state-default").appendTo($tbody);

	var $input_id = $('<input type="hidden" />').appendTo($tr1);
	...
	var $input_no = $('<input type="hidden" />').addClass("row-no").appendTo($tr1);
	$input_no.attr("name", "no["+idx+"]").val(idx);

	var $handle = $("<td />").addClass("handle").attr("rowspan", 2).appendTo($tr1);
	...
	var $td_birth = $("<td />").addClass("text-center").addClass("checkbox-wrapper").appendTo($tr2);
	...
	var $td_death = $("<td />").addClass("text-center").addClass("checkbox-wrapper").appendTo($tr2);
	...
	var $td_refer = $("<td />").addClass("text-center").addClass("checkbox-wrapper").appendTo($tr2);
	...
	var $td_delete = $("<td />").addClass("text-center").addClass("checkbox-wrapper").appendTo($tr2);
