 ...
 * @extends  Controller
 */
class Controller_List2 extends Controller_Base
{
	public function action_index()
	{
		...
		// ビューを設定
		$content = Presenter::forge('list2/index', 'view', null, 'top.tpl');
	...
	public function action_detail()
	{
		...
		// ビューを設定
		$content = Presenter::forge('list2/detail', 'view', null, 'list2.tpl');
		$content->date = $date;
